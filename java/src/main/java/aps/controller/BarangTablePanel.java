...
public class BarangTablePanel extends JPanel {
	...
	public BarangTablePanel(JPanel jPanel) {
		super();
		...
		backback.setIcon(new ImageIcon(getClass().getResource("/lancarjaya/icons/backback.png")));
		...
		back = new ButtonK("");
		back.setIcon(new ImageIcon(getClass().getResource("/lancarjaya/icons/back.png")));
		...
		rowPanel.add(ofPage);
		next = new ButtonK("");
		next.setIcon(new ImageIcon(getClass().getResource("/lancarjaya/icons/next.png")));
		...
		nextnext.setIcon(new ImageIcon(getClass().getResource("/lancarjaya/icons/nextnext.png")));
