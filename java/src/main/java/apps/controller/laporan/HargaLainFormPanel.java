...
public class HargaLainFormPanel extends JPanel {
	private static final long serialVersionUID = 1L;
	private LabelK titel;
	private HargaSatuan hargaSatuan;
	
	private TextFieldK jenisLainnya, merk, contoh, satuan, sumberInformasi, keterangan;
	...
	public HargaLainFormPanel(JPanel jPanel, MainForm mainForm1, HargaSatuan hargaSatuan1) {
		mainForm = mainForm1;
		...
		LabelK labelK = new LabelK("Jenis Jasa Lainnya");
		labelK.setPreferredSize(new Dimension(labelWidth, 35));
		add(labelK);
		
		jenisLainnya = new TextFieldK();
		jenisLainnya.setPreferredSize(new Dimension(textWidth, 35));
		add(jenisLainnya);
		...
		merk = new TextFieldK();
		merk.setPreferredSize(jenisLainnya.getPreferredSize());
		add(merk);
		...
		satuan.setPreferredSize(jenisLainnya.getPreferredSize());
		add(satuan);
		...
		hargaSatuanDecimalTextFieldK.setPreferredSize(jenisLainnya.getPreferredSize());
		...
		contoh.setPreferredSize(jenisLainnya.getPreferredSize());
		add(contoh);
		...
		sumberInformasi.setPreferredSize(jenisLainnya.getPreferredSize());
		add(sumberInformasi);
		...
		keterangan.setPreferredSize(jenisLainnya.getPreferredSize());
		add(keterangan);
		...
		simpanButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				rowData.addElement(jenisLainnya.getText());
				...
				rowData.addElement(1);
				hargaSatuan1.addRowHargaLain(rowEditted, rowData);
				afterSaved();
			}
		});
		add(simpanButton);
	...
	public void setTambah() {
		titel.setText("Tambah Harga Jasa Lainnya");
		rowEditted = null;
		resetButton.doClick();
		setVisible(true);
	}
	...
	public void setEdit(int row, Vector<Object> vector) {
		rowEditted = row;
		titel.setText("Edit Harga Jasa Lainnya");
		resetButton.doClick();
		setVisible(true);
		jenisLainnya.setText(vector.get(1).toString());
